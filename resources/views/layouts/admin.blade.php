...
<body class="">
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright">
            ...
            <a href="javascript:void(0)" target="_blank">Apex Solutions</a> we bring solutions to life.
          </div>
        </div>
      </footer>
    </div>
  ...
  <script src="{{ asset('js/admin/black-dashboard.min.js?v=1.0.0') }}"></script>
  <!-- Black Dashboard DEMO methods, don't include it in your project! -->
  <script src="{{ asset('css/demo/demo.js') }}"></script>
  <script>
